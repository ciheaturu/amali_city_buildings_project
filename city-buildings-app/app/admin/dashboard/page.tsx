...
function Card(props: { title: string; value: string; subtitle?: string }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 28, fontWeight: 900, marginTop: 8, color: "#38bdf8" }}>
        {props.value}
      </div>
...
export default function AdminDashboardPage() {
  ...
  const summary = useMemo(() => {
    ...
    return { totalBuildings, totalOccupants, avgOccupants, buildingsPerCity, avgOccPerCity, classCounts, points, center, cityNameById };
  }, [cities, buildings]);
    ...
    <main style={{ background: "#020617", minHeight: "100vh", color: "white" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: 24 }}>
        ...
        >
          ...
          <p style={{ opacity: 0.85, marginTop: 6 }}>Cross city overview. Signed in as {adminEmail}</p>
          ...
          <div style={{ marginTop: 12, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button onClick={() => router.push("/admin/buildings/new")} style={btnGreen}>Add new building</button>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <section style={{ borderRadius: 14, background: "#020617", border: "1px solid #1f2937", padding: 14 }}>
        ...
        <div style={{ marginTop: 14 }}>
          <section style={{ borderRadius: 14, background: "#020617", border: "1px solid #1f2937", padding: 14 }}>
            <h2 style={{ margin: 0, fontSize: 16, fontWeight: 800 }}>Buildings by classification across all cities</h2>
        ...
        <div style={{ marginTop: 14 }}>
          <section style={{ borderRadius: 14, background: "#020617", border: "1px solid #1f2937", overflow: "hidden" }}>
            <div style={{ padding: 12, borderBottom: "1px solid #1f2937" }}>
              <h2 style={{ margin: 0, fontSize: 16, fontWeight: 800 }}>Building locations across all cities</h2>
